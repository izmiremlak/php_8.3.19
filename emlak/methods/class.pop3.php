...
class POP3 {
   ...
   * @return bool
   */
  public function Authorise($host, $port = false, $tval = false, $username, $password, $debug_level = 0): bool {
    $this->host = $host;
   ...
   * @return string
   */
  private function getResponse($size = 128): string {
   ...
   * @return int
   */
  private function sendString($string): int {
   ...
   * @return bool
   */
  private function checkResponse($string): bool {
   ...
   * @param int $errline
   */
  private function catchWarning($errno, $errstr, $errfile, $errline): void {
    $this->error[] = [
