...
class SMTP {
   ...
   * @return bool
   */
  public function Connect($host, $port = 0, $tval = 30): bool {
   ...
   * @return bool
   */
  public function Authenticate($username, $password, $authtype='LOGIN', $realm='', $workstation=''): bool {
    if (empty($authtype)) {
      $authtype = 'LOGIN';
    }
...
/**
  ...
  public function Data(string $msg_data): bool {
     ...
     * a period '.' and append an additional period '.' to that
 ...
 /**
   ...
   * will send the message to the user's terminal if they are logged
