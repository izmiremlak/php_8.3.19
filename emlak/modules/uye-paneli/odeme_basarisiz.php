...
<div class="headerbg" <?= ($gayarlar->belgeler_resim != '') ? 'style="background-image: url(uploads/' . htmlspecialchars($gayarlar->belgeler_resim, ENT_QUOTES, 'UTF-8') . ');"' : ''; ?>>
    <div id="wrapper">
        <div class="headtitle">
            <h1><?= htmlspecialchars(dil("TX553"), ENT_QUOTES, 'UTF-8'); ?></h1>
            <div class="sayfayolu">
                <!--span>...</span-->
            </div>
        </div>
        ...
        <div class="content">
            <div class="uyedetay">
                <div class="uyeolgirisyap">
                    <h4 class="uyepaneltitle"><?= htmlspecialchars(dil("TX553"), ENT_QUOTES, 'UTF-8'); ?></h4>
                    ...
                    <div style="margin-top:60px;margin-bottom:60px;text-align:center;" id="BasvrTamam">
                        ...
                        <br/>
                        <h4><?= htmlspecialchars(dil("TX554"), ENT_QUOTES, 'UTF-8'); ?><br></h4><br><br>
                        <?php
                        if ($customs != '') {
