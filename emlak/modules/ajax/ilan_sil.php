...
$acc = $db->query("SELECT id, kid FROM hesaplar WHERE site_id_555=501 AND id=" . $ilan->acid)->fetch(PDO::FETCH_OBJ);
$kid = $acc->kid;
...
$db->query("UPDATE sayfalar SET durum='4' WHERE site_id_555=501 AND id" . $mulid);
?>
