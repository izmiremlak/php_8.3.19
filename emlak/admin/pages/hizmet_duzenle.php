            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=hizmet_duzenle&id=<?= sanitizeInput($snc->id); ?>" onsubmit="return false;" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="baslik" class="col-sm-3 control-label">Başlık</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="baslik" name="baslik" maxlength="32" value="<?= sanitizeInput($snc->baslik); ?>" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="kategori_id" id="kategori_id">
                                        ...
                                        ?>
                                        <option value="<?= sanitizeInput($kat->id); ?>" <?= ($kat->id == $snc->kategori_id) ? 'selected' : ''; ?>><?= sanitizeInput($kat->baslik); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group" style="display:none">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="kisa_icerik" name="kisa_icerik" maxlength="135" value="<?= sanitizeInput($snc->kisa_icerik); ?>" placeholder="">
                                </div>
                            </div>
                            <div class="form-group" style="display:none">
                                <label for="link" class="col-sm-3 control-label">Harici Link</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="link" name="link" value="<?= sanitizeInput($snc->link); ?>" placeholder="">
                                </div>
                            </div>
                            <div class="form-group" style="display:none">
                                <label for="icon" class="col-sm-3 control-label">Font Awesome Icon</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="icon" name="icon" value="<?= sanitizeInput($snc->icon); ?>" placeholder="örnek: fa fa-chrome">
                                </div>
                            </div>
                            <div class="form-group" style="display:none">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?= sanitizeInput($gorsel_boyutlari['hizmetler']['resim1']['thumb_x']); ?> x <?= sanitizeInput($gorsel_boyutlari['hizmetler']['resim1']['thumb_y']); ?> olmalıdır.</p>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <?= $fonk->bilgi(" Google'da rekabeti düşük kelimelerde organik olarak ilk sayfaya yükselmek için mutlaka aşağıdaki bilgileri doldurunuz. Sadece sayfa içeriği ile alakalı bilgiler giriniz."); ?>
                            <div class="form-group">
