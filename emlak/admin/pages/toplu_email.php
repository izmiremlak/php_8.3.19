                        ...
                        <div class="panel-group" id="accordion-test-2">
                            <div class="panel panel-pink panel-color">
                                ...
                                <div id="collapseOne-2" class="panel-collapse collapse" aria-expanded="true">
                                    <div class="panel-body">
                                        Sitenizin en alt(footer) kısmında yer alan bülten alanından, eklenen mail adreslerini bu alanda görebilir ve toplu mail gönderebilirsiniz. Ayrıca, toplu e-mail gönderme işlemlerini burada yapabilirsiniz.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=toplu_email" onsubmit="return false;" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    $data1 = explode(",", $gayarlar->bulten_email);
                                    $data2 = [];
                                    $data2ler = $db->query("SELECT email FROM hesaplar WHERE (site_id_555=501 OR site_id_888=100 OR site_id_777=501501 OR site_id_699=200 OR site_id_701=501501 OR site_id_702=300) AND tipi=0 AND mail_izin=1");
                            ...
                            <div class="form-group">
                                <div class="col-sm-11">
                                    Sisteme kayıtlı toplam <b><?= count($datalar); ?></b> adet e-posta bulunmaktadır.
                                </div>
                            </div>
                            <div align="right">
