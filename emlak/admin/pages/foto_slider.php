...
<div class="content">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title">Foto Slider</h4>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="btn-toolbar" role="toolbar">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=foto_slider_ekle';">
                    ...
                    <div class="panel panel-default m-t-20">
                        <div class="panel-body">
                            ...
                            if ($hesap->tipi != 2) {
                                ...
                                if ($sil != "") {
                                    // Silme işlemi
                                    $db->query("DELETE FROM slider_501 WHERE id=" . $sil);
                                    header("Location:index.php?p=foto_slider");
                                }
                                if ($_POST) {
                                    $idler = $_POST["id"];
                                    $action = $_POST["action"];
                                    if (count($idler) > 0) {
                                        foreach ($idler as $id) {
                                            ...
                                            if ($action == 'sil') {
                                                ...
                                                $db->query("DELETE FROM slider_501 WHERE id=" . $id);
                                            }
                                        } // FOREACH END
                                    } // eğer varsa
                                    header("Location:index.php?p=foto_slider");
                            ...
                            <table class="table table-hover mails datatable">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                    $sorgu = $db->query("SELECT * FROM slider_501 WHERE dil='" . $dil . "' ORDER BY id DESC LIMIT 0,500");
                                    while ($row = $sorgu->fetch(PDO::FETCH_OBJ)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= ($row->baslik == '') ? 'Slider ' . $i : sanitizeInput($row->baslik) ?></td>
                                            ...
                                            <td>
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="index.php?p=foto_slider_duzenle&id=<?= sanitizeInput($row->id) ?>">Düzenle</a></li>
                                                        <li><a href="index.php?p=foto_slider&sil=<?= sanitizeInput($row->id) ?>">Sil</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
