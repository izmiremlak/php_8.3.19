...
<div class="content">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title">Video Kategoriler</h4>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="btn-toolbar" role="toolbar">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=video_kategori_ekle';"> <i class="fa fa-plus"></i> Yeni Kategori Ekle</button>
                                </div>
                                <div class="btn-group">
                    ...
                    <div class="panel panel-default m-t-20">
                        <div class="panel-body">
                            ...
                            if ($hesap->tipi != 2) {
                                ...
                                if ($sil !== null) {
                                    $db->prepare("DELETE FROM kategoriler_501 WHERE id = ?")->execute([$sil]);
                                ...
                                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                    ...
                                    if (count($idler) > 0) {
                                        foreach ($idler as $id) {
                                            ...
                                            if ($action === 'sil') {
                                                $db->prepare("DELETE FROM kategoriler_501 WHERE id = ?")->execute([$id]);
                                            }
                                        }
                                    }
                            ...
                            <table class="table table-hover mails datatable">
                                ...
                                <tbody>
                                    <?php
                                    $sorgu = $db->prepare("SELECT * FROM kategoriler_501 WHERE tipi = 2 AND dil = ? ORDER BY id DESC LIMIT 0, 500");
                                    $sorgu->execute([$dil]);
                                    ...
                                    <tr>
                                        ...
                                        <td style="display:none"><?= ($dayarlar->permalink === 'Evet') ? 'kategori/' . sanitizeInput($row->url) : 'index.php?p=kategori&id=' . sanitizeInput((string)$row->id); ?></td>
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a href="index.php?p=video_kategori_duzenle&id=<?= sanitizeInput((string)$row->id); ?>">Düzenle</a></li>
                                                    <li><a href="index.php?p=video_kategoriler&sil=<?= sanitizeInput((string)$row->id); ?>">Sil</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
