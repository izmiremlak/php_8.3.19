...
// Sayfa bilgilerini veritabanından çekme
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=sayfa_duzenle&id=<?= sanitizeInput((string)$snc->id); ?>" onsubmit="return false;" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?= sanitizeInput((string)$gorsel_boyutlari['sayfalar']['resim']['width']); ?> x <?= sanitizeInput((string)$gorsel_boyutlari['sayfalar']['resim']['height']); ?> piksel olmalıdır.</p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?= sanitizeInput((string)$gorsel_boyutlari['sayfalar']['resim2']['width']); ?> x <?= sanitizeInput((string)$gorsel_boyutlari['sayfalar']['resim2']['height']); ?> piksel olmalıdır.</p>
                                </div>
                            </div>
                            <div class="form-group">
