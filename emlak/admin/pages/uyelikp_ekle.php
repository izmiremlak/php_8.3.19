...
<div class="content">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title">Yeni Paket Ekle</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=uyelikp_ekle" onsubmit="return false;" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="cp2 input-group colorpicker-component">
                                        <input name="renk" type="text" value="#808080" class="form-control" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="checkbox checkbox-success">
                                        <input id="gizle" type="checkbox" name="gizle" value="1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="text" class="form-control" id="aylik_ilan_limit" name="aylik_ilan_limit" value="" placeholder="">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="text" class="form-control" id="ilan_resim_limit" name="ilan_resim_limit" value="" placeholder="">
                                </div>
                                <span style="font-size:14px;">Sınırsız/Limitsiz için 0 yazınız.</span>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="text" class="form-control" id="danisman_limit" name="danisman_limit" value="" placeholder="">
                                </div>
                                <span style="font-size:14px;">Sınırsız/Limitsiz için 0 yazınız.</span>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="checkbox checkbox-success">
                                        <input id="danisman_onecikar" type="checkbox" name="danisman_onecikar" value="1">
                                        <label for="danisman_onecikar"><strong>Evet</strong></label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group" id="danisman_onecikar_con" style="display:none">
                                <label class="col-sm-3 control-label">Anasayfada Gösterme Süresi</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control" id="danisman_onecikar_sure" name="danisman_onecikar_sure" value="" placeholder="">
                                </div>
                                <div class="col-sm-2">
                                    <select class="form-control" name="danisman_onecikar_periyod">
                                        <?php
                                        foreach ($periyod as $k => $v) {
                                            ?><option value="<?= sanitizeInput((string)$k); ?>"><?= sanitizeInput($v); ?></option><?php
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="text" class="form-control" name="ilan_yayin_sure" value="" placeholder="">
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div id="kapsayici">
                                        <div class="row ucret">
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" name="sure[]" value="" placeholder="Süre">
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" name="ucret[]" value="" placeholder="Ücret">
                                            </div>
                                            <div class="col-sm-1">
