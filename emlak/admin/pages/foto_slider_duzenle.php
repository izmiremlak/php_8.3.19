...
$snc = $db->prepare("SELECT * FROM slider_501 WHERE id=:ids");
...
<div class="content">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title">Foto Slayt Düzenle</h4>
            </div>
        </div>
        <div class="row">
            <!-- Col 1 -->
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=foto_slider_duzenle&id=<?= sanitizeInput($snc->id) ?>" onsubmit="return false;" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="aciklama" name="aciklama" value="<?= sanitizeInput($snc->aciklama) ?>" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <br />
                                    <img src="../uploads/thumb/<?= sanitizeInput($snc->resim) ?>" width="250" id="resim_src">
