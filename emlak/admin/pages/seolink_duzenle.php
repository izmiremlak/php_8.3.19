...
// Seo link bilgilerini veritabanından çekme
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=seolink_duzenle&id=<?= sanitizeInput((string)$snc->id); ?>" onsubmit="return false;" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="website" name="website" value="<?= sanitizeInput($snc->website); ?>" placeholder="">
                                </div>
                            </div>
                            <div class="form-group" style="display:none">
