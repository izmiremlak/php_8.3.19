...
<div class="content">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title">Yeni Hizmet Kategori Ekle</h4>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=hizmet_kategori_ekle" onsubmit="return false;" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="adi" class="col-sm-3 control-label">Kategori Başlık</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?= sanitizeInput($gorsel_boyutlari['kategoriler']['resim2']['orjin_x']); ?> x <?= sanitizeInput($gorsel_boyutlari['kategoriler']['resim2']['orjin_y']); ?> px olmalıdır.</p>
                                </div>
                            </div>
                            <?= $fonk->bilgi(" Google'da rekabeti düşük kelimelerde organik olarak ilk sayfaya yükselmek için mutlaka aşağıdaki bilgileri doldurunuz. Sadece sayfa içeriği..."); ?>
                            <div class="form-group">
